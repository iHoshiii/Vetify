...
export default function PrivacySection({ isExpanded, onToggle }: SectionProps) {
  const items = [
    { label: 'Data Sharing', desc: 'Opt-in or out of analytics tracking and personalized ads.' },
  ...
  return (
    <div className="border-b border-slate-100 last:border-0">
      ...
      >
        <span className="text-sm font-bold text-slate-700">🔒 Privacy & Permissions</span>
        <svg
